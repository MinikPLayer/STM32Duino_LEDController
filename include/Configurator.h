...
// WiFi Settings
#define EEPROM_SLOT_WIFI_SSID_LENFTH 5 // Max 32B
#define EEPROM_SLOT_WIFI_SSID EEPROM_SLOT_WIFI_SSID_LENFTH + 1	// SSID - Max 32B
#define EEPROM_SLOT_WIFI_PASS_LENGTH EEPROM_SLOT_WIFI_SSID + 32 // Max 32B
#define EEPROM_SLOT_WIFI_PASS EEPROM_SLOT_WIFI_PASS_LENGTH + 1
